...
export default function TempLogin() {
  ...
  const handleLogin = async (e: React.FormEvent) => {
    ...
    try {
      ...
      if (error) {
        ...
        // Set a flag in localStorage to indicate direct navigation
        localStorage.setItem('direct_navigation', 'true');
        
        // Use direct navigation with a slight delay
        setTimeout(() => {
  ...
  return (
    <div className="p-8 max-w-md mx-auto mt-10">
      <h1 className="text-2xl font-bold mb-4">Temporary Login</h1>
